	...
	internal class InitCommandHandler : XmlCommandHandlerBase
	{
		...
		protected override void BuildXml()
		{
			...
			for ( int i = 0 ; i < aTypes.Length ; i++ )
			{
				...
				bool bHasChildren = Achilles.Acme.Storage.IO.Directory.Exists( sTargetDirectory ) && ( Achilles.Acme.Storage.IO.Directory.GetDirectories( oTypeInfo.GetTargetDirectory() ).Length > 0 );
